...
public sealed class CaravanSaveData { public string Id { get; set; } = string.Empty; public string OwnerSettlementId { get; set; } = string.Empty; public string Type { get; set; } = string.Empty; public decimal Capacity { get; set; } public int RequiredWorkers { get; set; } public bool IsAvailable { get; set; } }
...
public sealed class TradeRouteSaveData { public string Id { get; set; } = string.Empty; public string FromSettlementId { get; set; } = string.Empty; public string ToSettlementId { get; set; } = string.Empty; public string Type { get; set; } = string.Empty; public decimal Distance { get; set; } public int TravelDays { get; set; } public bool IsEnabled { get; set; } public decimal DifficultyMultiplier { get; set; } = 1m; public List<RoutePointSaveData> Points { get; set; } = new(); }
